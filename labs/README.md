...
1. Create a CDH+CDSW cluster following [these instructions](https://github.com/durandkwok/EdgeToAI-Demo) and **PLEASE NOTE** that due to a minor MiNiFi bug, `service minifi start` was commented out in `setup.sh`. You will be prompted to explicitly start MiNiFi in Lab 5. 
